...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]>{
    ...
    private final int WEATHER_ID = 71;
    ...
    private void loadWeatherData() {
        ...
        getSupportLoaderManager().initLoader(WEATHER_ID, null, MainActivity.this);
    ...
    // TODO (6) Remove any and all code from MainActivity that references FetchWeatherTas
